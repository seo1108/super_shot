...
import com.charles.supershot.utils.Log;
...
public class SerializableHttpCookie implements Serializable {
    private static final long serialVersionUID = 2965916031592201525L;
    ...
    public String encode(HttpCookie cookie) {
        ...
        try {
            ...
            Log.e("IOException in encodeCookie", e);
            return null;
        }
    ...
    public HttpCookie decode(String encodedCookie) {
        ...
        try {
            ...
            Log.e("IOException in decodeCookie", e);
        } catch (ClassNotFoundException e) {
            Log.e("ClassNotFoundException in decodeCookie", e);
        }
